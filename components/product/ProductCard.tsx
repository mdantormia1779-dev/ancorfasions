    ...
    <div className="group relative flex flex-col gap-2">
      <div className="relative aspect-[3/4] overflow-hidden bg-zinc-100">
        ...
        <div className="absolute bottom-4 left-0 right-0 z-20 flex justify-center gap-2 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          <Button size="icon" variant="secondary" className="h-10 w-10 rounded-full shadow-md hover:bg-black hover:text-white">
      ...
      <div className="flex flex-col pt-2">
        <h3 className="text-sm font-medium text-zinc-900 group-hover:underline decoration-1 underline-offset-4">
