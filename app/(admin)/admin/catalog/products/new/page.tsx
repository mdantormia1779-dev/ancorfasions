...
import { generateProductDescriptionAction, generateSeoMetadataAction } from '@/app/actions/catalog/ai.actions';
...
export default function NewProductPage() {
  ...
  const handleGenerateDescription = async () => {
    ...
    const result = await generateProductDescriptionAction(name, { /* Pass real attributes here if implemented */ });
  ...
  const handleGenerateSeo = async () => {
    ...
    if (!name || !desc) {
      toast({ title: 'Name and description required', description: 'Please enter name and description first.', variant: 'destructive' });
      return;
    }
                ...
                <CardContent className="space-y-4">
                  <FormField control={form.control} name="name" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input placeholder="Premium Cotton T-Shirt" {...field} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  ...
                  <FormField control={form.control} name="description" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Textarea className="min-h-[200px]" placeholder="Detailed product description..." {...field} value={field.value || ''} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                </CardContent>
                ...
                <CardContent className="space-y-4 grid grid-cols-2 gap-4">
                  ...
                  <FormField control={form.control} name="sku" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input placeholder="TSHIRT-001" {...field} value={field.value || ''} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                </CardContent>
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    <Button type="button" variant="outline" size="sm" onClick={handleGenerateSeo} disabled={isGeneratingSeo}>
                      <Sparkles className="mr-2 h-4 w-4 text-purple-500" />
                      {isGeneratingSeo ? 'Generating SEO...' : 'AI Generate SEO'}
                    </Button>
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <FormField control={form.control} name="seo.metaTitle" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input placeholder="Max 60 chars" {...field} value={field.value || ''} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  <FormField control={form.control} name="seo.metaDescription" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Textarea placeholder="Max 160 chars" {...field} value={field.value || ''} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                </CardContent>
                ...
                <CardContent className="space-y-4">
                  ...
                  <FormField control={form.control} name="brandId" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input placeholder="UUID" {...field} value={field.value || ''} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
