        ...
        <TabsContent value="configuration" className="space-y-6 outline-none">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure primary and fallback AI models for the platform.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">Used for complex analysis and content generation.</p>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium">Fast Model (Chat/Support)</label>
                  <Input defaultValue="gemini-1.5-flash" disabled />
                  <p className="text-xs text-muted-foreground">Used for low-latency tasks like customer support bots.</p>
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure safety settings for generated content.</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="rounded-md border p-4 bg-muted/20">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Currently set to BLOCK_MEDIUM_AND_ABOVE across all categories.</p>
                  </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Manage and version system prompts used across the platform.</CardDescription>
              </div>
              <Button>
            ...
            <CardContent>
              <div className="rounded-md border p-8 text-center text-muted-foreground">
                <p>Prompt management has been moved to a dedicated dashboard.</p>
