          ...
          <Card key={warehouse.id} className="flex flex-col">
            <CardHeader className="pb-4">
              <div className="mb-2 flex items-start justify-between">
                ...
                <Badge
                  variant={
                    warehouse.status === "Active" ? "default" : "destructive"
                  }
                >
                  {warehouse.status}
                </Badge>
              ...
              <CardDescription className="mt-1 flex items-center">
                <MapPin className="mr-1 h-3 w-3" /> {warehouse.address}
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-1 flex-col gap-4">
              ...
              <div className="mt-auto flex items-center border-t pt-4 text-sm">
                ...
                <span className="ml-auto text-muted-foreground">
                  {warehouse.staffCount} Staff
                </span>
              </div>

              <div className="flex gap-2 pt-2">
                <Link
                  href={`/admin/operations/warehouses/${warehouse.id}`}
                  className="w-full"
                >
