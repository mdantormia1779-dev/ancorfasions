    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage pick lists, packing, and dispatch.</p>
        </div>
        <Button>
            ...
            <TableBody>
              {pickLists?.map((list) => (
                <TableRow key={list.id}>
                  <TableCell className="font-medium">{list.list_number}</TableCell>
                  ...
                  <TableCell>{format(new Date(list.created_at), 'PP')}</TableCell>
