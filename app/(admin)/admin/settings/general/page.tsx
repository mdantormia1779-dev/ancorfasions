    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Manage your store&apos;s contact information, branding, and social media presence.
        </p>
      </div>
      <GeneralSettingsForm initialStoreInfo={storeInfo} initialSocialLinks={socialLinks} />
    </div>
  );
}
