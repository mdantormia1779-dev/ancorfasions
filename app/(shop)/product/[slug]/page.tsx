  ...
  return (
    <div className="min-h-screen bg-white pb-20 pt-4">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mb-8 mt-4 flex items-center text-[10px] uppercase tracking-[0.2em] text-gray-400">
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-20">
          ...
          <div className="sticky top-24 flex flex-col lg:col-span-5">
            <div className="mb-6 border-b border-gray-100 pb-6">
              ...
              <h1
                className={`${jost.className} mb-4 text-3xl font-light leading-[1.1] tracking-tight text-[#1A1A1A] md:text-5xl`}
              >
                {product.name}
              </h1>
              ...
              <div className="mt-2 flex items-end gap-4">
                ...
                {product.stock_quantity > 0 ? (
                  <span className="ml-auto border border-green-100 bg-green-50 px-3 py-1.5 text-xs font-bold uppercase tracking-widest text-green-700">
                    In Stock
                  </span>
                ) : (
                  <span className="ml-auto border border-red-100 bg-red-50 px-3 py-1.5 text-xs font-bold uppercase tracking-widest text-red-700">
                    Sold Out
                  </span>
                )}
              </div>
            ...
            <div className="divide-y divide-gray-100 border-t border-gray-100">
              <details className="group" open>
                <summary className="flex cursor-pointer list-none items-center justify-between py-5 text-sm font-medium uppercase tracking-widest">
                ...
                <p className="animate-fade-in pb-5 text-sm leading-relaxed text-gray-500">
                  {product.description ||
              ...
              <details className="group">
                ...
                <div className="animate-fade-in space-y-4 pb-5">
                  <div className="flex items-center gap-3 text-sm text-gray-500">
                    <Truck
                      className="h-5 w-5 text-[#C9A86A]"
                      strokeWidth={1.5}
                    />
                    <span>
                      Free Standard Delivery over ৳5,000 (Inside Dhaka)
                    </span>
                  </div>
                  <div className="flex items-center gap-3 text-sm text-gray-500">
                    <RefreshCw
            ...
            {/* Trust Badges */}
            <div className="mt-8 flex items-center justify-between border-t border-gray-100 pt-8 opacity-60">
