...
export class GeminiProvider implements AIProvider {
  ...
  async generateText(request: AIGenerateRequest): Promise<IntegrationResponse<{ text: string; usage?: { promptTokens: number; completionTokens: number } }>> {
    try {
      ...
      return {
        ...
        error: {
          ...
          message: data.error?.message || 'Failed to generate text using Gemini'
        }
      };
