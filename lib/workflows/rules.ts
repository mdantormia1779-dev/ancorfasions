import { sendNotificationAction, generateAiContentAction, alertAdminAction } from './actions';
...
export const automationRules: Record<string, ActionFunction[]> = {
  ...
  'stock.low': [
    async (payload) => {
      ...
      const aiResponse = await generateAiContentAction('generate_reorder_email', {
