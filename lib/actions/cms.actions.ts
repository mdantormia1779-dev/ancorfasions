...
const DEFAULT_SLIDES: HeroSlide[] = [
  { id: 'default-1', media_url: '/images/home/hero-banner.png', cta_url: '/products?sort=newest', display_order: 0 },
  { id: 'default-2', media_url: '/images/home/hero-slide-2.png', cta_url: '/categories/ethnic', display_order: 1 },
  { id: 'default-3', media_url: '/images/home/hero-slide-3.png', cta_url: '/categories/summer', display_order: 2 },
];
...
export async function upsertHeroSlide(slide: Partial<HeroSlide> & { media_url: string; cta_url: string }) {
  try {
    const supabase = await createClient();
    ...
    if (existing) {
      ...
      const { data: newSection, error } = await supabase
        .from('homepage_sections')
        .insert({ title: 'Hero Banner', section_type: 'HERO', is_active: true, display_order: 0 })
        .select('id')
        .single();
