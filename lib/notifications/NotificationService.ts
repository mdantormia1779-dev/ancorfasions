...
export class NotificationService {
  ...
  static async dispatch(event: NotificationEvent) {
    ...
    try {
      ...
      const isMarketingEnabled = preferences
      ...
      const subject = TemplateEngine.hydrate(
