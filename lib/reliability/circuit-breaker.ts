...
export const PaymentServiceCircuitBreaker = new CircuitBreaker({ failureThreshold: 3, resetTimeout: 30000 });
export const CourierServiceCircuitBreaker = new CircuitBreaker({ failureThreshold: 5, resetTimeout: 15000 });
