...
const lowStockItems = [
  { id: 1, name: "Navy Blue Suit", sku: "SUIT-NAVY-M", stock: 3, threshold: 10 },
  { id: 2, name: "Silk Tie", sku: "TIE-SILK-RED", stock: 1, threshold: 5 },
  { id: 3, name: "Leather Oxford Shoes", sku: "SHOE-OXF-BLK-10", stock: 0, threshold: 5 },
  { id: 4, name: "White Dress Shirt", sku: "SHIRT-WHT-L", stock: 4, threshold: 15 },
];

export function LowStockAlerts() {
  return (
    <Card className="border-slate-200/60 shadow-sm border-t-4 border-t-amber-500">
